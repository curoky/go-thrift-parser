...
struct Type {
    ...
    5: map<string, Annotation> Annotations
...
struct Namespace {
    1: string Language
    2: string Name
    3: map<string, Annotation> Annotations
}
...
struct ConstValueExtra {
    ...
    2: i64 Index = -1 // the include index if Index > -1
...
union ConstTypedValue {
    ...
    // 6: map<ConstValue, ConstValue> Map
...
struct Constant {
    ...
    4: map<string, Annotation> Annotations
}
...
struct Field {
    ...
    6: map<string, Annotation> Annotations
}
...
// typedef StructLike Struct
// typedef StructLike Union
// typedef StructLike Exception

struct Function {
    1: string Name
    2: bool Oneway
    3: optional Type ReturnType
    4: list<Field> Arguments
    5: list<Field> Exceptions
    6: map<string, Annotation> Annotations
}
...
struct Thrift {
    ...
    4: map<string, Namespace> Namespaces
